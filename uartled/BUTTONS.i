...
u8 BUTTON_STATE_REGISTER = 0; 


void readButtonStates()
{
 BUTTON_STATE_REGISTER = (!((((MDR_PORT_TypeDef *)(0x400C8000) )->RXTX & RIGHT__BUTTON) != 0)) ? (BUTTON_STATE_REGISTER | 0x01) : (BUTTON_STATE_REGISTER & ~0x01);
 BUTTON_STATE_REGISTER = (!((((MDR_PORT_TypeDef *)(0x400C8000) )->RXTX & TOP____BUTTON) != 0)) ? (BUTTON_STATE_REGISTER | 0x02) : (BUTTON_STATE_REGISTER & ~0x02);
 BUTTON_STATE_REGISTER = (!((((MDR_PORT_TypeDef *)(0x400C8000) )->RXTX & SELECT_BUTTON) != 0)) ? (BUTTON_STATE_REGISTER | 0x04) : (BUTTON_STATE_REGISTER & ~0x04);
 BUTTON_STATE_REGISTER = (!((((MDR_PORT_TypeDef *)(0x400C8000) )->RXTX & LEFT___BUTTON) != 0)) ? (BUTTON_STATE_REGISTER | 0x08) : (BUTTON_STATE_REGISTER & ~0x08);
 BUTTON_STATE_REGISTER = (!((((MDR_PORT_TypeDef *)(0x400C8000) )->RXTX & BACK___BUTTON) != 0)) ? (BUTTON_STATE_REGISTER | 0x10) : (BUTTON_STATE_REGISTER & ~0x10);
 BUTTON_STATE_REGISTER = (!((((MDR_PORT_TypeDef *)(0x400C8000) )->RXTX & BOTTOM_BUTTON) != 0)) ? (BUTTON_STATE_REGISTER | 0x20) : (BUTTON_STATE_REGISTER & ~0x20);
...
void buttonLedsDemo()
{
 int bstate = (((BUTTON_STATE_REGISTER & 0x02) != EBS_RELEASED) ? (EBS_PRESSED) : (EBS_RELEASED));
 
 if ( bstate != ((((MDR_PORT_TypeDef *)(0x400C0000) )->RXTX & LED3_pin) != 0) )
 if (bstate) ((MDR_PORT_TypeDef *)(0x400C0000) )->SETTX = LED3_pin; else ((MDR_PORT_TypeDef *)(0x400C0000) )->CLRTX = LED3_pin;

 bstate = (((BUTTON_STATE_REGISTER & 0x01) != EBS_RELEASED) ? (EBS_PRESSED) : (EBS_RELEASED));
 
 if ( bstate != ((((MDR_PORT_TypeDef *)(0x400C0000) )->RXTX & LED4_pin) != 0) )
 if (bstate) ((MDR_PORT_TypeDef *)(0x400C0000) )->SETTX = LED4_pin; else ((MDR_PORT_TypeDef *)(0x400C0000) )->CLRTX = LED4_pin;

 bstate = (((BUTTON_STATE_REGISTER & 0x20) != EBS_RELEASED) ? (EBS_PRESSED) : (EBS_RELEASED));
 
 if ( bstate != ((((MDR_PORT_TypeDef *)(0x400C0000) )->RXTX & LED5_pin) != 0) )
 if (bstate) ((MDR_PORT_TypeDef *)(0x400C0000) )->SETTX = LED5_pin; else ((MDR_PORT_TypeDef *)(0x400C0000) )->CLRTX = LED5_pin;

 bstate = (((BUTTON_STATE_REGISTER & 0x08) != EBS_RELEASED) ? (EBS_PRESSED) : (EBS_RELEASED));
 
 if ( bstate != ((((MDR_PORT_TypeDef *)(0x400C0000) )->RXTX & LED6_pin) != 0) )
 if (bstate) ((MDR_PORT_TypeDef *)(0x400C0000) )->SETTX = LED6_pin; else ((MDR_PORT_TypeDef *)(0x400C0000) )->CLRTX = LED6_pin;

 bstate = (((BUTTON_STATE_REGISTER & 0x04) != EBS_RELEASED) ? (EBS_PRESSED) : (EBS_RELEASED));
 if ( bstate != ((((MDR_PORT_TypeDef *)(0x400C0000) )->RXTX & LED1_pin) != 0) || bstate != ((((MDR_PORT_TypeDef *)(0x400C0000) )->RXTX & LED2_pin) != 0) )
 if (bstate) ((MDR_PORT_TypeDef *)(0x400C0000) )->SETTX = LED1_pin|LED2_pin; else ((MDR_PORT_TypeDef *)(0x400C0000) )->CLRTX = LED1_pin|LED2_pin;

 bstate = (((BUTTON_STATE_REGISTER & 0x10) != EBS_RELEASED) ? (EBS_PRESSED) : (EBS_RELEASED));
 if ( bstate != ((((MDR_PORT_TypeDef *)(0x400C0000) )->RXTX & LED7_pin) != 0) || bstate != ((((MDR_PORT_TypeDef *)(0x400C0000) )->RXTX & LED8_pin) != 0) )
 if (bstate) ((MDR_PORT_TypeDef *)(0x400C0000) )->SETTX = LED7_pin|LED8_pin; else ((MDR_PORT_TypeDef *)(0x400C0000) )->CLRTX = LED7_pin|LED8_pin;
