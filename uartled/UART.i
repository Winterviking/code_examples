...
void putc(void* ptr, char Data )
{
 ...
 while ( ((((MDR_UART_TypeDef *)(0x40030000) )->FR & ((uint32_t)0x00000020)) >> 5 ) || ((((MDR_UART_TypeDef *)(0x40030000) )->FR & ((uint32_t)0x00000008)) >> 3) ); 

 
 ((MDR_UART_TypeDef *)(0x40030000) )->DR = Data;
...
void initUART(MDR_UART_TypeDef* UARTx)
{
 ...
 cpuclock /= (1 << ((((MDR_RST_CLK_TypeDef *)(0x40020000) )->UART_CLOCK & ((uint32_t)0x0007)) >> 0));
 }
 ...
 UARTx->CR = ((uint32_t)0x00000100);
 UARTx->CR |= ((uint32_t)0x00000001); 
