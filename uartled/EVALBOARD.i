...
void initEvalboard(){
 ...
 initUART(((MDR_UART_TypeDef *)(0x40030000) ));
...
void initClockEvalboard(){
 ...
 ((MDR_RST_CLK_TypeDef *)(0x40020000) )->CPU_CLOCK = ((uint32_t)0x00000002) |
 ((uint32_t)0x00000000) |
 ((uint32_t)0x00000100) |
 ((uint32_t)0x00000000) << 4; 

 
 ((MDR_RST_CLK_TypeDef *)(0x40020000) )->PLL_CONTROL = ((uint32_t)0x00000004) |
 ((uint32_t)0x00000005) << 8; 

 
 ((MDR_RST_CLK_TypeDef *)(0x40020000) )->PLL_CONTROL |= ((uint32_t)0x00000008);
 ((MDR_RST_CLK_TypeDef *)(0x40020000) )->PLL_CONTROL &= ~((uint32_t)0x00000008);

 
 maxpause_mks=(HCLK/20300000)*40;for(ipause = 0; ipause < maxpause_mks; ipause++);;
 while ((((MDR_RST_CLK_TypeDef *)(0x40020000) )->CLOCK_STATUS&((uint32_t)0x00000002))==0);

 
 
 ((MDR_RST_CLK_TypeDef *)(0x40020000) )->PER_CLOCK|=((uint32_t)(1 << ((((uint32_t)(0x40018000)) >> 15) & 0x1F))); 

 
 ((MDR_EEPROM_TypeDef *)(0x40018000) )->CMD = ((uint32_t)0x00000000);
 ...
 ((MDR_RST_CLK_TypeDef *)(0x40020000) )->PER_CLOCK = 
 
 
 ((uint32_t)(1 << ((((uint32_t)(0x40018000)) >> 15) & 0x1F))) |
 ((uint32_t)(1 << ((((uint32_t)(0x40020000)) >> 15) & 0x1F))) |
 
 ((uint32_t)(1 << ((((uint32_t)(0x40030000)) >> 15) & 0x1F))) |
 ...
 ((uint32_t)(1 << ((((uint32_t)(0x40070000)) >> 15) & 0x1F))) |
 ((uint32_t)(1 << ((((uint32_t)(0x40078000)) >> 15) & 0x1F))) |
 
 
 
 ((uint32_t)(1 << ((((uint32_t)(0x40098000)) >> 15) & 0x1F))) |
 
 
 
 ((uint32_t)(1 << ((((uint32_t)(0x400B8000)) >> 15) & 0x1F))) |
 ((uint32_t)(1 << ((((uint32_t)(0x400C0000)) >> 15) & 0x1F))) |
 ((uint32_t)(1 << ((((uint32_t)(0x400C8000)) >> 15) & 0x1F))) |
 
 
 
 ((uint32_t)(1 << ((((uint32_t)(0x400E8000)) >> 15) & 0x1F))) 
 ...
 ((MDR_RST_CLK_TypeDef *)(0x40020000) )->UART_CLOCK = ((uint32_t)0x00000001) << 0 |
 ENABLE << 24;
