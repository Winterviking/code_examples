...
void Timer1_IRQHandler(void) {
 ...
 u32 INTERRUPT_TIMER_STATUS = ((MDR_TIMER_TypeDef *)(0x40070000) )->STATUS;
 ((MDR_TIMER_TypeDef *)(0x40070000) )->STATUS&=~1;

 if ( (INTERRUPT_TIMER_STATUS & (((uint32_t)0x1) << 5)) > 0 )
 {
 
 
 bufZ = ((MDR_TIMER_TypeDef *)(0x40070000) )->CCR1 - TZp;

 Zaccum[Zptr] = bufZ;
 ((MDR_TIMER_TypeDef *)(0x40070000) )->CCR2 = TZp + bufZ + (bufZ >> 1);
 TZp = ((MDR_TIMER_TypeDef *)(0x40070000) )->CCR1;
 ...
 ZCC++;
 if ( ZCC == 2 ){
 ((MDR_TIMER_TypeDef *)(0x40070000) )->IE = 0x0420;
 ecss_status = ECSS_PRIMARY_SYNC;
 }

 break;
 case ECSS_EMERGENCY_SYNC:
 ((MDR_TIMER_TypeDef *)(0x40070000) )->CCR3 = 0;
 ((MDR_TIMER_TypeDef *)(0x40070000) )->CCR4 = 0;
 ((MDR_TIMER_TypeDef *)(0x40070000) )->CCR31 = 0;
 ((MDR_TIMER_TypeDef *)(0x40070000) )->CCR41 = 0;

 ((MDR_TIMER_TypeDef *)(0x40078000) )->CCR1 = 0;
 ((MDR_TIMER_TypeDef *)(0x40078000) )->CCR2 = 0;
 ((MDR_TIMER_TypeDef *)(0x40078000) )->CCR3 = 0;
 ((MDR_TIMER_TypeDef *)(0x40078000) )->CCR4 = 0;
 ((MDR_TIMER_TypeDef *)(0x40078000) )->CCR11 = 0;
 ((MDR_TIMER_TypeDef *)(0x40078000) )->CCR21 = 0;
 ((MDR_TIMER_TypeDef *)(0x40078000) )->CCR31 = 0;
 ((MDR_TIMER_TypeDef *)(0x40078000) )->CCR41 = 0;
 ...
 }else if ( (((MDR_TIMER_TypeDef *)(0x40070000) )->STATUS & (((uint32_t)0x1) << 10)) > 0 ){
 ...
 Zperiod = ((MDR_TIMER_TypeDef *)(0x40070000) )->CCR1 + ((istantPERIOD>0)?(1):(-1))*(((istantPERIOD>0)?(istantPERIOD):(-istantPERIOD))>>1);
 ...
 break;
 case ECSS_NORMAL_OPERATION:
 ecss_status = ( ((32 <= CTz) && (CTz <= 36)) || (CTz == 0) ) ? ECSS_NORMAL_OPERATION : ECSS_EMERGENCY_SYNC; 

 if ( 34 != CTz ) integral_error++;
 else integral_error = 0;

 if (3600 < integral_error ) ecss_status = ECSS_EMERGENCY_SYNC;

 
 ((MDR_TIMER_TypeDef *)(0x40078000) )->CNT = 0x00000000;

 
 ((MDR_TIMER_TypeDef *)(0x40070000) )->CCR3 = Zperiod >>1;
 ((MDR_TIMER_TypeDef *)(0x40070000) )->CCR4 = Zperiod >>1;
 ((MDR_TIMER_TypeDef *)(0x40070000) )->CCR31 = Zperiod >>1 + Zperiod >>2;
 ((MDR_TIMER_TypeDef *)(0x40070000) )->CCR41 = Zperiod >>1 + Zperiod >>2;

 ((MDR_TIMER_TypeDef *)(0x40078000) )->CCR1 = Zperiod >>1;
 ((MDR_TIMER_TypeDef *)(0x40078000) )->CCR2 = Zperiod >>1;
 ((MDR_TIMER_TypeDef *)(0x40078000) )->CCR3 = Zperiod >>1;
 ((MDR_TIMER_TypeDef *)(0x40078000) )->CCR4 = Zperiod >>1;
 ((MDR_TIMER_TypeDef *)(0x40078000) )->CCR11 = Zperiod >>1 + Zperiod >>2;
 ((MDR_TIMER_TypeDef *)(0x40078000) )->CCR21 = Zperiod >>1 + Zperiod >>2;
 ((MDR_TIMER_TypeDef *)(0x40078000) )->CCR31 = Zperiod >>1 + Zperiod >>2;
 ((MDR_TIMER_TypeDef *)(0x40078000) )->CCR41 = Zperiod >>1 + Zperiod >>2;

 break;
 };
 CTz = 0;
 ((MDR_TIMER_TypeDef *)(0x40070000) )->CNT = 0x00000000; 
 }
}
...
void initFrontDetectionModule(){
 ...
 ((MDR_TIMER_TypeDef *)(0x40070000) )->IE = 0x0020;
}
