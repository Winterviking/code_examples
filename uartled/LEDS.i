...
void InitPortLED(void) {
 ((MDR_PORT_TypeDef *)(0x400C0000) )->FUNC &= ~((0x3FF << (LED0_OFS << 1))); 
 ((MDR_PORT_TypeDef *)(0x400C0000) )->ANALOG |= LEDS_MASK; 
 ((MDR_PORT_TypeDef *)(0x400C0000) )->PWR |= (0x155 << (LED0_OFS << 1)); 
 ((MDR_PORT_TypeDef *)(0x400C0000) )->RXTX &= ~LEDS_MASK;
 ((MDR_PORT_TypeDef *)(0x400C0000) )->OE |= LEDS_MASK;
}

void ShiftLights(void) {
 u32 ovf;
 ((MDR_PORT_TypeDef *)(0x400C0000) )->RXTX = (((MDR_PORT_TypeDef *)(0x400C0000) )->RXTX & ~LEDS_MASK) | (CurrentLights & LEDS_MASK);
...
void Lights(u32 mask) {
 ((MDR_PORT_TypeDef *)(0x400C0000) )->RXTX = (((MDR_PORT_TypeDef *)(0x400C0000) )->RXTX & ~LEDS_MASK) | (mask & LEDS_MASK);
}
