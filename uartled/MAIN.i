...
void main ()
{
 ...
 ((MDR_PORT_TypeDef *)(0x400C0000) )->SETTX = LED1_pin|LED2_pin;
 maxpause_ms=(HCLK/20300)*400;for(ipause = 0; ipause < maxpause_ms; ipause++);;
 ((MDR_PORT_TypeDef *)(0x400C0000) )->CLRTX = LED1_pin|LED2_pin;
 maxpause_ms=(HCLK/20300)*400;for(ipause = 0; ipause < maxpause_ms; ipause++);;
 ((MDR_PORT_TypeDef *)(0x400C0000) )->SETTX = LED7_pin|LED8_pin;
 maxpause_ms=(HCLK/20300)*400;for(ipause = 0; ipause < maxpause_ms; ipause++);;
 ((MDR_PORT_TypeDef *)(0x400C0000) )->CLRTX = LED7_pin|LED8_pin;
 maxpause_ms=(HCLK/20300)*400;for(ipause = 0; ipause < maxpause_ms; ipause++);;


 for ( i = 3; i > 0; i-- )
 {
 ((MDR_PORT_TypeDef *)(0x400C0000) )->SETTX = LED1_pin;maxpause_ms=(HCLK/20300)*30;for(ipause = 0; ipause < maxpause_ms; ipause++);;
 ((MDR_PORT_TypeDef *)(0x400C0000) )->SETTX = LED2_pin;maxpause_ms=(HCLK/20300)*30;for(ipause = 0; ipause < maxpause_ms; ipause++);;
 ((MDR_PORT_TypeDef *)(0x400C0000) )->SETTX = LED3_pin;maxpause_ms=(HCLK/20300)*30;for(ipause = 0; ipause < maxpause_ms; ipause++);;
 ((MDR_PORT_TypeDef *)(0x400C0000) )->CLRTX = LED1_pin;maxpause_ms=(HCLK/20300)*30;for(ipause = 0; ipause < maxpause_ms; ipause++);;
 ((MDR_PORT_TypeDef *)(0x400C0000) )->SETTX = LED4_pin;maxpause_ms=(HCLK/20300)*30;for(ipause = 0; ipause < maxpause_ms; ipause++);;
 ((MDR_PORT_TypeDef *)(0x400C0000) )->CLRTX = LED2_pin;maxpause_ms=(HCLK/20300)*30;for(ipause = 0; ipause < maxpause_ms; ipause++);;
 ((MDR_PORT_TypeDef *)(0x400C0000) )->SETTX = LED5_pin;maxpause_ms=(HCLK/20300)*30;for(ipause = 0; ipause < maxpause_ms; ipause++);;
 ((MDR_PORT_TypeDef *)(0x400C0000) )->CLRTX = LED3_pin;maxpause_ms=(HCLK/20300)*30;for(ipause = 0; ipause < maxpause_ms; ipause++);;
 ((MDR_PORT_TypeDef *)(0x400C0000) )->SETTX = LED6_pin;maxpause_ms=(HCLK/20300)*30;for(ipause = 0; ipause < maxpause_ms; ipause++);;
 ((MDR_PORT_TypeDef *)(0x400C0000) )->CLRTX = LED4_pin;maxpause_ms=(HCLK/20300)*30;for(ipause = 0; ipause < maxpause_ms; ipause++);;
 ((MDR_PORT_TypeDef *)(0x400C0000) )->SETTX = LED7_pin;maxpause_ms=(HCLK/20300)*30;for(ipause = 0; ipause < maxpause_ms; ipause++);;
 ((MDR_PORT_TypeDef *)(0x400C0000) )->CLRTX = LED5_pin;maxpause_ms=(HCLK/20300)*30;for(ipause = 0; ipause < maxpause_ms; ipause++);;
 ((MDR_PORT_TypeDef *)(0x400C0000) )->SETTX = LED8_pin;maxpause_ms=(HCLK/20300)*30;for(ipause = 0; ipause < maxpause_ms; ipause++);;
 ((MDR_PORT_TypeDef *)(0x400C0000) )->CLRTX = LED6_pin;maxpause_ms=(HCLK/20300)*30;for(ipause = 0; ipause < maxpause_ms; ipause++);;
 ((MDR_PORT_TypeDef *)(0x400C0000) )->CLRTX = LED7_pin;maxpause_ms=(HCLK/20300)*30;for(ipause = 0; ipause < maxpause_ms; ipause++);;
 ((MDR_PORT_TypeDef *)(0x400C0000) )->CLRTX = LED8_pin;maxpause_ms=(HCLK/20300)*30;for(ipause = 0; ipause < maxpause_ms; ipause++);;
 ...
 ((MDR_PORT_TypeDef *)(0x400C0000) )->SETTX = LED1_pin|LED2_pin|LED3_pin|LED4_pin|LED5_pin|LED6_pin|LED7_pin|LED8_pin;
 maxpause_ms=(HCLK/20300)*300;for(ipause = 0; ipause < maxpause_ms; ipause++);;
 ((MDR_PORT_TypeDef *)(0x400C0000) )->CLRTX = LED1_pin|LED2_pin|LED3_pin|LED4_pin|LED5_pin|LED6_pin|LED7_pin|LED8_pin;

 tfp_printf("Project \"%s\" %s %s\n","INTERSTELLAR","0.1.6","2016" );
 ...
 PC++;
 maxpause_ms=(HCLK/20300)*250;for(ipause = 0; ipause < maxpause_ms; ipause++);;
