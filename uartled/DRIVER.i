...
const u32 HCLK = ((uint32_t)8000000)*(((uint32_t)0x00000005) + 1);
u32 maxpause_ms;
u32 maxpause_mks;
u32 maxpause_s;
...
void MarkM4Routine(void){
 ...
 ((MDR_PORT_TypeDef *)(0x400B8000) )->SETTX = 0x1;
 ((MDR_PORT_TypeDef *)(0x400C0000) )->SETTX = LED3_pin;

 if ( PC > 9000 ) PC = 0;


 ((MDR_PORT_TypeDef *)(0x400B8000) )->CLRTX = 0x1;
 ((MDR_PORT_TypeDef *)(0x400C0000) )->CLRTX = LED3_pin;
