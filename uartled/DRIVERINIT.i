...
void SetupUART(MDR_UART_TypeDef* UARTx)
{
 ...
 UARTx->IBRD = integerdivider + realspeed + speederror ;
 UARTx->FBRD = fractionaldivider;

 
 tmpreg = UARTx->LCR_H;
 tmpreg |= ((uint16_t)0x0060) | ((uint16_t)0x0000) | ((uint16_t)0x0000) | ((uint16_t)0x0010);
 UARTx->LCR_H = tmpreg;
...
void ClockInit(){
 ...
 maxpause=HCLK*40/1000000;for(ipause = 0; ipause < maxpause; ipause++);;
 ...
 SetupUART( ((MDR_UART_TypeDef *)(0x40030000) ) );
}
